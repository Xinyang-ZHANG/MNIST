...
#
# Generated by export_simulation on Fri Mar 10 09:23:22 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './mnist_image_blkmem.sh' script.

./mnist_image_blkmem.sh -reset_run
...
./mnist_image_blkmem.sh -noclean_files

For more information on the script, please type './mnist_image_blkmem.sh -help'.
