...
(
	...
	output [23:0]                                m_axis_video_tdata,    // AXI4-Stream data
...
reg           mnist_en_r1,mnist_en_r2,mnist_en_r3,mnist_en_r4;
...
begin
    ...
    begin
        ...
        mnist_en_r1 <= mnist_en;
        mnist_en_r2 <= mnist_en_r1;
        mnist_en_r3 <= mnist_en_r2;
        mnist_en_r4 <= mnist_en_r3;
    end    
end

wire  [15:0]  Gray = ({cmos_d_16bit_d1[4:0],3'b000}*8'd38 + {cmos_d_16bit_d1[10:5],2'b00}*8'd75 + {cmos_d_16bit_d1[15:11],3'b000}*8'd15);
assign  s_axis_tdata = mnist_en_r4?{Gray[14:7],Gray[14:7],Gray[14:7]}:{cmos_d_16bit_d1[4:0],3'b000,cmos_d_16bit_d1[10:5],2'b00,cmos_d_16bit_d1[15:11],3'b000};
assign  mnist_data = Gray[14:7];
assign  mnist_data_valid = mnist_en_r4 & cmos_href_16bit_d1;
