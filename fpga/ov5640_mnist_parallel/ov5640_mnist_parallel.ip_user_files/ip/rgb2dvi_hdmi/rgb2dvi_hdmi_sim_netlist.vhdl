...
-- Date        : Tue Dec 27 16:10:32 2022
-- Host        : DESKTOP-C3MDEKS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/Alinx/Alinx7010/Self_learning/ov5640_mnist/ov5640_mnist.runs/rgb2dvi_hdmi_synth_1/rgb2dvi_hdmi_sim_netlist.vhdl
-- Design      : rgb2dvi_hdmi
...
entity rgb2dvi_hdmi_OutputSERDES is
  port (
  ...
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_OutputSERDES : entity is "OutputSERDES";
end rgb2dvi_hdmi_OutputSERDES;

architecture STRUCTURE of rgb2dvi_hdmi_OutputSERDES is
  signal I : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_OutputSERDES_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_OutputSERDES_0 : entity is "OutputSERDES";
end rgb2dvi_hdmi_OutputSERDES_0;

architecture STRUCTURE of rgb2dvi_hdmi_OutputSERDES_0 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_OutputSERDES_2 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_OutputSERDES_2 : entity is "OutputSERDES";
end rgb2dvi_hdmi_OutputSERDES_2;

architecture STRUCTURE of rgb2dvi_hdmi_OutputSERDES_2 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_OutputSERDES_4 is
  port (
    TMDS_Data_p : out STD_LOGIC_VECTOR ( 0 to 0 );
    TMDS_Data_n : out STD_LOGIC_VECTOR ( 0 to 0 );
    SerialClk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_OutputSERDES_4 : entity is "OutputSERDES";
end rgb2dvi_hdmi_OutputSERDES_4;

architecture STRUCTURE of rgb2dvi_hdmi_OutputSERDES_4 is
  signal I : STD_LOGIC;
  signal SHIFTIN1 : STD_LOGIC;
  signal SHIFTIN2 : STD_LOGIC;
  signal NLW_SerializerMaster_OFB_UNCONNECTED : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_SyncAsync is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_SyncAsync : entity is "SyncAsync";
end rgb2dvi_hdmi_SyncAsync;

architecture STRUCTURE of rgb2dvi_hdmi_SyncAsync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_TMDS_Encoder is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_TMDS_Encoder : entity is "TMDS_Encoder";
end rgb2dvi_hdmi_TMDS_Encoder;

architecture STRUCTURE of rgb2dvi_hdmi_TMDS_Encoder is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_TMDS_Encoder_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_TMDS_Encoder_1 : entity is "TMDS_Encoder";
end rgb2dvi_hdmi_TMDS_Encoder_1;

architecture STRUCTURE of rgb2dvi_hdmi_TMDS_Encoder_1 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_TMDS_Encoder_3 is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    PixelClk : in STD_LOGIC;
    vid_pData : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_TMDS_Encoder_3 : entity is "TMDS_Encoder";
end rgb2dvi_hdmi_TMDS_Encoder_3;

architecture STRUCTURE of rgb2dvi_hdmi_TMDS_Encoder_3 is
  signal cnt_t_2 : STD_LOGIC_VECTOR ( 4 downto 1 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_ResetBridge is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst_n : in STD_LOGIC;
    PixelClk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_ResetBridge : entity is "ResetBridge";
end rgb2dvi_hdmi_ResetBridge;

architecture STRUCTURE of rgb2dvi_hdmi_ResetBridge is
  signal aRst_int : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int : signal is "true";
begin
SyncAsyncx: entity work.rgb2dvi_hdmi_SyncAsync
     port map (
      AS(0) => aRst_int,
      PixelClk => PixelClk,
      \out\(0) => \out\(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity rgb2dvi_hdmi_rgb2dvi is
  port (
    TMDS_Clk_p : out STD_LOGIC;
    TMDS_Clk_n : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of rgb2dvi_hdmi_rgb2dvi : entity is "rgb2dvi";
  attribute kClkPrimitive : string;
  attribute kClkPrimitive of rgb2dvi_hdmi_rgb2dvi : entity is "MMCM";
  attribute kClkRange : integer;
  attribute kClkRange of rgb2dvi_hdmi_rgb2dvi : entity is 1;
  attribute kGenerateSerialClk : string;
  attribute kGenerateSerialClk of rgb2dvi_hdmi_rgb2dvi : entity is "FALSE";
  attribute kRstActiveHigh : string;
  attribute kRstActiveHigh of rgb2dvi_hdmi_rgb2dvi : entity is "FALSE";
end rgb2dvi_hdmi_rgb2dvi;

architecture STRUCTURE of rgb2dvi_hdmi_rgb2dvi is
...
begin
  oen <= \<const1>\;
ClockSerializer: entity work.rgb2dvi_hdmi_OutputSERDES
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[0].DataEncoder\: entity work.rgb2dvi_hdmi_TMDS_Encoder
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[0].DataSerializer\: entity work.rgb2dvi_hdmi_OutputSERDES_0
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[1].DataEncoder\: entity work.rgb2dvi_hdmi_TMDS_Encoder_1
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[1].DataSerializer\: entity work.rgb2dvi_hdmi_OutputSERDES_2
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
\DataEncoders[2].DataEncoder\: entity work.rgb2dvi_hdmi_TMDS_Encoder_3
     port map (
      PixelClk => PixelClk,
...
\DataEncoders[2].DataSerializer\: entity work.rgb2dvi_hdmi_OutputSERDES_4
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
...
LockLostReset: entity work.rgb2dvi_hdmi_ResetBridge
     port map (
      PixelClk => PixelClk,
      aRst_n => aRst_n,
      \out\(0) => pRstLck
...
entity rgb2dvi_hdmi is
  ...
  attribute NotValidForBitStream of rgb2dvi_hdmi : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of rgb2dvi_hdmi : entity is "rgb2dvi_hdmi,rgb2dvi,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of rgb2dvi_hdmi : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of rgb2dvi_hdmi : entity is "rgb2dvi,Vivado 2017.4";
end rgb2dvi_hdmi;

architecture STRUCTURE of rgb2dvi_hdmi is
  attribute kClkPrimitive : string;
...
begin
U0: entity work.rgb2dvi_hdmi_rgb2dvi
     port map (
      PixelClk => PixelClk,
      SerialClk => SerialClk,
      TMDS_Clk_n => TMDS_Clk_n,
