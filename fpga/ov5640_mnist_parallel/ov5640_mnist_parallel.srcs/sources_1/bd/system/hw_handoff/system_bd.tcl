...
proc create_root_design { parentCell } {
  ...
  set S_AXIS_ov5640 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_ov5640 ]
  ...
  set hdmi_io_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:vid_io_rtl:1.0 hdmi_io_out ]

  # Create ports
  set LOCKED_O_0 [ create_bd_port -dir O LOCKED_O_0 ]
  set PXL_CLK_5X_O_0 [ create_bd_port -dir O -type clk PXL_CLK_5X_O_0 ]
  set PXL_CLK_O [ create_bd_port -dir O -type clk PXL_CLK_O ]
  set clk142m [ create_bd_port -dir O -type clk clk142m ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXIS_ov5640} \
 ] $clk142m
  set rstn142m [ create_bd_port -dir O -from 0 -to 0 -type rst rstn142m ]
  ...
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports S_AXIS_ov5640] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins cmos_rst/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net v_axi4s_vid_out_0_vid_io_out [get_bd_intf_ports hdmi_io_out] [get_bd_intf_pins v_axi4s_vid_out_0/vid_io_out]
  connect_bd_intf_net -intf_net v_tc_0_vtiming_out [get_bd_intf_pins v_axi4s_vid_out_0/vtiming_in] [get_bd_intf_pins v_tc_0/vtiming_out]

  # Create port connections
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_ports LOCKED_O_0] [get_bd_pins axi_dynclk_0/LOCKED_O]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_5X_O [get_bd_ports PXL_CLK_5X_O_0] [get_bd_pins axi_dynclk_0/PXL_CLK_5X_O]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_ports PXL_CLK_O] [get_bd_pins axi_dynclk_0/PXL_CLK_O] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports clk142m] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_140M_peripheral_aresetn [get_bd_ports rstn142m] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins rst_processing_system7_0_150M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cmos_rst/S_AXI/Reg] SEG_coms_rst_Reg
